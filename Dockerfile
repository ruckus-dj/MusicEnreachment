...
RUN set -eu; \
    case "$TARGETARCH" in \
        amd64) ffmpeg_arch='64'; ffmpeg_sha256='6f180db3c615393bb7e4a1b25d4a63395f97c850ee93244bb5428b8b15080ddc' ;; \
        arm64) ffmpeg_arch='arm64'; ffmpeg_sha256='b21e18ee9492a22b7e09c5c068e03f05124ecf9bd2380c6835e11d5576873535' ;; \
        *) echo "unsupported architecture: $TARGETARCH" >&2; exit 1 ;; \
    esac; \
    ffmpeg_archive="ffmpeg-n9.0.1-11-ge47273f4d9-linux${ffmpeg_arch}-gpl-9.0.tar.xz"; \
    curl --fail --silent --show-error --location \
        --output "/tmp/$ffmpeg_archive" \
        "https://github.com/BtbN/FFmpeg-Builds/releases/download/autobuild-2026-09-01-13-13/$ffmpeg_archive"; \
    printf '%s  %s\n' "$ffmpeg_sha256" "/tmp/$ffmpeg_archive" | sha256sum --check --status; \
    ...
    rm -rf /tmp/$ffmpeg_archive /tmp/ffmpeg; \
    case "$TARGETARCH" in \
