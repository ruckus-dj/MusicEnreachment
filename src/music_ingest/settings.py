...
def load_runtime_settings(session: Session) -> RuntimeSettings:
    values = {
        ...
        'worker_concurrency': _setting_value(session, 'processing.worker_concurrency'),
    ...
    return RuntimeSettings(
        ...
        worker_concurrency=_parse_int(values['worker_concurrency'], defaults.worker_concurrency),
...
def save_runtime_settings(session: Session, settings: RuntimeSettings) -> None:
    values = {
        ...
        'processing.worker_concurrency': str(settings.worker_concurrency),
