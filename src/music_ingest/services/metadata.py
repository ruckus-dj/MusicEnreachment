...
from music_ingest.services.normalize.metadata import CanonicalMetadata, CanonicalSource
...
def fallback_metadata(
    ...
    return CanonicalMetadata(
        ...
        int(disc_total),
        genres,
        values.get('MUSICBRAINZ_RECORDINGID'),
        tuple(filter(None, values.get('MUSICBRAINZ_ARTISTID', '').split('; '))),
        tuple(filter(None, values.get('MUSICBRAINZ_ALBUMARTISTID', '').split('; '))),
