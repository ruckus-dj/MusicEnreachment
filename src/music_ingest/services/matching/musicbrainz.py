...
from music_ingest.services.enrichment.artwork import ArtworkCandidate, ArtworkFormat
from music_ingest.services.matching.musicbrainz_mapping import (
    ...
    async def _lookup(self, request: MusicBrainzLookupRequest, captured_at: datetime) -> MusicBrainzResult:
        if request.release_mbid is not None:
            ...
            if outcome is not None:
                return outcome
            if request.recording_mbid is None:
